...
$product = (Invoke-WebRequest -Uri "http://vault.in.okinta.ge:7020/api/kv/iqfeed_product").Content
$version = (Invoke-WebRequest -Uri "http://vault.in.okinta.ge:7020/api/kv/iqfeed_product_version").Content
$login = (Invoke-WebRequest -Uri "http://vault.in.okinta.ge:7020/api/kv/iqfeed_login").Content
$password = (Invoke-WebRequest -Uri "http://vault.in.okinta.ge:7020/api/kv/iqfeed_password").Content
